...
func (v *SyntaxValidator) Validate(email string) models.ValidationResult {
	// Common Internet mailbox subset. Quoted local-parts and SMTPUTF8 require
	// capability-aware handling and are intentionally not accepted here.
	...
	return models.ValidationResult{
		Status:    "pass",
		Reason:    "Valid supported email format",
		RawSignal: "supported_format",
